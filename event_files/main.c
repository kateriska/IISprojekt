...
/*                                                                                 */
/* Reseni vytvoril(a) a odevzdava: Katerina Fortova (xforto00)                     */
/*                                                                                 */
/***********************************************************************************/
...
void Timer0Init(void)
{
	...
	TPM0_CnSC(1) = 0x28; // using green color (channel 1) of RGB LED
...
int main(void)
{
    ...
    while (1) {
        ...
        TPM0_CnV(1) = compare; // compare value to channel 1 of RGB (green color)
