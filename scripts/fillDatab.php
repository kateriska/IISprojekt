...
(11, "Alena", "Krenova", "$2y$09$cvwm2Y8KiOZj7TX4k8H69eP1MhQpIn4Y017HdnlV4uQfmhAyBHSEG", 1, "student"), -- heslo: student
(12, "Petr", "Hruby", "$2y$09$ZAgr62guPScYvDMmGR1cZOMAH4/sGGs5LzVklQj5gmbba9wR7EeP.", 2, "lektor"), -- heslo: lektor
(13, "Marta", "Janska", "$2y$09$7y6oCWp1JdOPln6qq54AUevkc4qZjj3tHy03WCtsct6/j9aLqLF9y", 3, "garant"), -- heslo: garant
(14, "Ondrej", "Kocour", "$2y$09$nDtAvLGGJHQtKQamTRUVDuG.SqdGsiwtxGI6lrlFaE4V2odraPSgS", 4, "vedouci") -- heslo: vedouci
;';
...
('ZPR', 'Zaklady programovani', 'Seznamuje se zaklady programovani a algoritmizace.', 'Programovani', 3500, 13 , 14),
('ZOPP', 'Zaklady OOP', 'Seznamuje se zaklady objektove orientovanych jazyku.', 'Programovani', 4000, 13 , 14),
('CTZ', 'Citace a psani odbornych textu', 'Seznamuje se spravnym citovanim zdroju a formalnimi potrebami pro psani odbornych textu. Vhodne hlavne pro studenty, co budou psat bakalarskou nebo diplomovou praci.', 'Typografie', 1500, 9 , 14),
...
('F208', 'Manesova 220/3, Brno', 'poslucharna', 120),
('G505', 'Manesova 220/3, Brno', 'laborator', 30),
('G507', 'Manesova 220/3, Brno', 'laborator', 30),
('I007', 'Hutarova 183/6, Brno', 'laborator', 20),
...
('ZOPP', '2019-12-01', '15:00:00.000000', 'G507', 4, 'Konani seminare. Prosim zopakujte si/nastudujte zaklady jazyka PHP a Python.', 'cviceni', 15, 120,'ne'),
...
('ZPR', '2019-12-16', '13:00:00.000000', 'H009', 12, 'Cviceni v laboratori. Budete seznameni s laboratornim radem.', 'cviceni', 20, 120,'ne'),
('CTZ', '2019-12-10', '18:00:00.000000', 'F208', 12, 'Uvodni hodina. Popovidame si hlavne o citacnich normach ISO.', 'prednaska', 120, 120,'ne'),
('CTZ', '2019-12-18', '20:00:00.000000', '', 12, 'Bodovany ukol, vizte na pripravu https://www.knihovnazn.cz/files/citace.pdf', 'domaci ukol', 120, '','ne'),
...
('CTZ', 'Citace a psani odbornych textu', 'Seznamuje se spravnym citovanim zdroju a formalnimi potrebami pro psani odbornych textu. Vhodne hlavne pro studenty, co budou psat bakalarskou nebo diplomovou praci.', 'Typografie', 2000, 9, 14, 9),
('CADZ', 'Zaklady programu CAD', 'Seznamuje se zaklady modelovani pomoci CAD technologii. Vhodne zvlaste pro zajemce z fakult strojnich.', 'Strojirenstvi', 3500, 3, 8, 3);";
